...
**Important scope note.** The locked seven-city core reported in the final analysis does **not** require ERA5 because meteorological coverage was not available consistently across all seven cities in the original archived analysis. The ERA5 code is retained here to make the earlier climate-integration workflow auditable and reproducible rather than silently omitting it.
